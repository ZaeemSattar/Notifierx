...
import droid.zaeem.notifierx.activity.DetailedImportantMessageActivity;
...
/*        if(!CacheModel.getStringList(Constants.Keys.IMPORTANT_LIST).isEmpty())
        ...
        if(databaseHandler.getAllMessages("important").size()!=0)
        {
            setUpRecyclerview();
    ...
    public void setUpRecyclerview() {
       /* final ArrayList<String> strings= CacheModel.getStringList(Constants.Keys.INBOX_LIST);
        ...
        final List<Message> messages= databaseHandler.getAllMessages("important");
        ...
        recyclerView.addOnItemTouchListener(
                new RecyclerItemClickListener(getActivity().getApplicationContext(), new RecyclerItemClickListener.OnItemClickListener() {
                    ...
                    public void onItemClick(View view, int position) {
                        Intent intent= new Intent(getActivity(), DetailedImportantMessageActivity.class);
