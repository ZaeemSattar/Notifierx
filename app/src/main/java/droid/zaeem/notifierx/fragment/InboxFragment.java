...
public class InboxFragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       /* if(!CacheModel.getStringList(Constants.Keys.INBOX_LIST).isEmpty() && !CacheModel.getStringList(Constants.Keys.INBOX_LIST_TITLE).isEmpty())
        ...
        if(databaseHandler.getAllMessages("inbox").size()!=0)
        {
            setUpRecyclerview();
    ...
    public void setUpRecyclerview() {
       /* final ArrayList<String> strings= CacheModel.getStringList(Constants.Keys.INBOX_LIST);
        ...
        final List<Message> messages= databaseHandler.getAllMessages("inbox");
        ...
        recyclerView.addOnItemTouchListener(
                new RecyclerItemClickListener(getActivity().getApplicationContext(), new RecyclerItemClickListener.OnItemClickListener() {
                    ...
                    public void onItemClick(View view, int position) {
                        Intent intent= new Intent(getActivity(), DetailedInboxMessageActivity.class);
