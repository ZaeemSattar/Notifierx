 ...
 */
public class DetailedStarredMessageActivity extends AppCompatActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        inflater.inflate(R.menu.menu_detailed_starred_message, menu);
        return true;
        ...
        builder
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                 ...
                 /*       ArrayList<String> messages = CacheModel.getStringList(Constants.Keys.INBOX_LIST);
                        ...
                        databaseHandler.deleteMessage(databaseHandler.getMessage(++positon,"starred"),"starred");
