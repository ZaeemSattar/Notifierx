 ...
 */
public class DetailedInboxMessageActivity extends AppCompatActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        inflater.inflate(R.menu.menu_detailed_inbox_message, menu);
        return true;
        ...
        builder
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                 ...
                 /*       ArrayList<String> messages = CacheModel.getStringList(Constants.Keys.INBOX_LIST);
                        ...
                        databaseHandler.deleteMessage(databaseHandler.getMessage(++positon,"inbox"),"inbox");
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                     /*   ArrayList<String> messages = CacheModel.getStringList(Constants.Keys.INBOX_LIST);
                        ...
                        databaseHandler.addMessage(databaseHandler.getMessage(++positon,"inbox"),"starred");
                        finish();
